    ...
    if(res.data.length>0){
      ...
      if(isLogin){
        ...
        if(values.userType === "doctor"){
          ...
          openNotification('Login Successful, welcome Doctor!');
        }
        else {
          history.push("/dashboard/patient");
          openNotification('Login Successful, welcome!');
        }
      }
      else {
      ...
      openNotification('this information doesnt match anything in our records'); 
    }  
  };
    ...
    <div id="login" className="block loginBlock">
      <div className="container-fluid">
        <div className="titleHolder">
          ...
          <p>New patients must recieve authorization from Doctor</p>
        </div>
        <Form
          name="normal_login"
